...
<sec:authorize access="hasRole('ROLE_ADMIN')">
        <h2>
            <spring:url var="deleteUrl" value="/users/delete/{id}">
                <spring:param name="id" value="${user.id}"/>
            </spring:url>
            <form:form method="POST" action="${deleteUrl}" modelAttribute="user">
    ...
    <sec:authorize access="hasRole('ROLE_ADMIN')">
        <h2>
            <spring:url var="editUrl" value="/users/edit/{id}">
                <spring:param name="id" value="${user.id}" />
            </spring:url>
            <form:form method="GET" action="${editUrl}" modelAttribute="user">
