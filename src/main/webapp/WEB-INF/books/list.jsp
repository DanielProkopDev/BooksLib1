  ...
  <div class="content">
    ...
    <div class="books">
      <table>
        ...
        <tr>
          <td>
            <spring:message code="label.Book.count"/>
          </td>
          <td>
            <spring:message code="label.Book.title"/>
          </td>
          <td>
            <spring:message code="label.Book.AuthorfName"/>
          </td>
          <td>
            <spring:message code="label.Book.AuthorlName"/>
          </td>
          <td>
            <spring:message code="label.Book.detailedDescription"/>
          </td>
          <td>
            <spring:message code="label.Book.price"/>
          </td>
          <td>
            <spring:message code="label.Book.status"/>
          </td>
          <td>
